...
export const Route = createFileRoute("/admin/leads")({
  head: () => ({
    meta: [
      { title: "Contact Leads | Sartaj Solar Water System Admin" },
      { name: "description", content: "Demo contact leads captured from the website form." },
      { property: "og:title", content: "Contact Leads | Sartaj Solar Water System Admin" },
      { property: "og:description", content: "Demo contact leads." },
