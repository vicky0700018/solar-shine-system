...
export const Route = createFileRoute("/admin/")({
  head: () => ({
    meta: [
      { title: "Dashboard | Sartaj Solar Water System Admin" },
      { name: "description", content: "Demo admin dashboard for Sartaj Solar Water System." },
      { property: "og:title", content: "Dashboard | Sartaj Solar Water System Admin" },
      { property: "og:description", content: "Demo admin dashboard." },
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            ...
            <Link to="/admin/leads" className="text-sm font-bold text-secondary hover:text-primary">
              View all
            </Link>
          </div>
