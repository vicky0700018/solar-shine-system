...
export const Route = createFileRoute("/admin/settings")({
  head: () => ({
    meta: [
      { title: "Settings | Sartaj Solar Water System Admin" },
      { name: "description", content: "Edit demo business information shown on the website." },
      { property: "og:title", content: "Settings | Sartaj Solar Water System Admin" },
      { property: "og:description", content: "Edit demo business information." },
